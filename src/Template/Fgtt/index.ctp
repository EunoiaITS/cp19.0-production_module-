                ...
                <table class="table table-bordered">
                    ...
                    <?php foreach($fgtt as $mr): ?>
                        <tr>
                            ...
                            <td><?= $mr->location ?></td>
                            <td><?= $mr->created_by ?></td>
                            <td><a href="<?php echo $this->url->build(['controller' => 'Fgtt', 'action' => $action, $mr->id]); ?>"><?php if($role == 'verifier'){echo 'Verify';}elseif($role == 'approve_1'){echo 'Approve';}else{echo 'Edit';} ?></a></td>
                        </tr>
                    <?php endforeach; ?>
                    </tbody>
                </table>
