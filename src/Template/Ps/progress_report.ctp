...
<div class="planner-from">
    <div class="container-fluid">
        <div class="row">
            <div class="part-title-planner text-uppercase text-center"><b>Production Planner Progress-Report Date</b></div>
            <form action="#" class="planner-relative">
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                            <p class="cn-text">Tender No <span class="planner-fright">:</span></p>
                        </div>
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text">TNB 380/2016</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text">SO 12345</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text">TNB Rawing</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text text-uppercase">RMU INS</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text text-uppercase">ZZTT</p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                            <p class="cn-text">Type  <span class="planner-fright">:</span></p>
                        </div>
                        <div class="col-sm-5 col-xs-6">
