        ...
        <div class="row">
            <div class="col-sm-12 col-sm-12">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text">MIT <?php foreach($mit as $m){echo $m->created_by;}?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5 col-xs-6">
                            <p class="cn-main-text">MIT <?php foreach($mit as $m){echo $m->verified_by;}?></p>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-3 col-xs-6">
            ...
            <div class="col-sm-offset-8 col-sm-4 col-xs-12">
                <div class="prepareted-by-csn">
                    <form action="<?php echo $this->Url->build(['controller'=>'mit','action'=>'approval',$sales->id])?>" method="post">
