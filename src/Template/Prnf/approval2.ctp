...
<div class="planner-from">
    <form action="<?php echo $this->Url->build(['controller'=>'prnf','action'=>'approval2',$prnf->id]);?>" method="post" enctype="multipart/form-data">
    <div class="container-fluid">
        ...
        <div class="col-sm-offset-8 col-sm-4 col-xs-12">
            <div class="prepareted-by-csn">
                    <input type="hidden" name="approved2_by" value="<?= $pic?>">
                    <input type="hidden" name="status" value="approved1">
