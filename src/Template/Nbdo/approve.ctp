                    ...
                    <table class="table table-bordered">
                        ...
                        <?php foreach($items as $item): ?>
                            <tr>
                                ...
                                <td><?= $item->quantity ?></td>
                                <td><a href="#" rel="<?= $item->id ?>" class="trigger">View</a></td>
                                <th></th>
                            </tr>
                            <div id="dialog<?= $item->id ?>" style="display:none">
                                <div>
                                    <iframe width="100%" height="850" src="<?php echo $this->request->webroot.$item->document; ?>"></iframe>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        </tbody>
